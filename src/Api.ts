...
const json : Profile= {
  ...
  projectHistory: [    
    ...
    },  
    {
      ...
      usedTechologies: ["C++", "C++11", "Objective C", "C#", "iOS", "Linux", "Windows", "git", "Visual Studio", "Game Development", "Unity3D", "Mobile"],
      relatedSites: [],
    ...
    new RestosProject(
    {
      ...
      usedTechologies: ["Ionic", "Angular","Android", "iOS", "git" , "Typescript", "Javascript", "Html", "CSS", "Mobile"],
      relatedSites: [],
    ...
    },
    {
      ...
      relatedSites: [],
      coverPicture: "./portfolio-resources/AnalyticsCover.png",
      backgroundStyle: "Light",
      previewColumns:  1,
      previewRows: 1,
      hideInGrid: true,
