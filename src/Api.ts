import { ProjectPreview } from "./Models/job-position";
import { Profile } from "./Models/profile"
import { MobileProject, Project, RestosProject, RobotTournamentProject } from "./Models/project";
...
export const GetResume = () => {
  const json : Profile = {
    ...
    projectHistory: [    
      ...
      new RestosProject(
      {
        ...
        hideInGrid: false,
        jobPositionId: 7,
        images: ["/portfolio-resources/Restos/Mesa.png", "/portfolio-resources/Restos/mesa3.png"]
      },
        ["/portfolio-resources/Restos/sconapp1.png",
        "/portfolio-resources/Restos/sconapp2.png",
        "/portfolio-resources/Restos/sconapp3.png"
        ]
      ),
      new RobotTournamentProject(
        {
          id: 16,
        ...
        ["/portfolio-resources/RoboTournament/referi/app1.jpg",
          "/portfolio-resources/RoboTournament/referi/arbitro2.jpg",
          "/portfolio-resources/RoboTournament/referi/arbitro3.jpg",
          "/portfolio-resources/RoboTournament/referi/arbitro4.jpg"],
        ["/portfolio-resources/RoboTournament/referi/app1.jpg",
          "/portfolio-resources/RoboTournament/referi/assistant1.jpg",
          "/portfolio-resources/RoboTournament/referi/juez3.jpg",
          "/portfolio-resources/RoboTournament/referi/juez4.jpg"],
        ["/portfolio-resources/RoboTournament/Event1.jpg",
          "/portfolio-resources/RoboTournament/Event2.jpg",
          "/portfolio-resources/RoboTournament/Event3.jpg",
          "/portfolio-resources/RoboTournament/Event4.jpg"]
      ),
      ...
      ),
      {
        ...
        hideInGrid: false,
        jobPositionId: 7,
        images: ["/portfolio-resources/Chatbot/1.jpg",
                "/portfolio-resources/Chatbot/2.jpg",
                "/portfolio-resources/Chatbot/3.jpg",
                "/portfolio-resources/Chatbot/4.jpg",
                "/portfolio-resources/Chatbot/5.jpg",
                "/portfolio-resources/Chatbot/6.jpg",
                "/portfolio-resources/Chatbot/7.jpg",
        ]
      },
      {
        id: 22,
  ...
  FillJobPositionWithProjectInfo(json)
  return json;
}
...
const AddSkill = (skillMap : Map<string, Skill>, skill: Skill) => {
  ...
  if (skill.childof) {
    let parent = skillMap.get(skill.childof)
    parent?.childs.push(skill.name);
  }
}
export const GetSkillList = (projectList : Project[]) : Skill[]=> {
  const skills = new Map<string, Skill>()

  AddSkill(skills, new Skill("C++", null, false, "language"))
  AddSkill(skills, new Skill("C++11", "C++", true, "language"))
  AddSkill(skills, new Skill("C++14", "C++", true, "language"))
  AddSkill(skills, new Skill("C++17", "C++", true, "language"))
  AddSkill(skills, new Skill("Angular", null, false, "language"))
  AddSkill(skills, new Skill("Html", null, false, "technology"))
  AddSkill(skills, new Skill("CSS", null, false, "technology"))
  AddSkill(skills, new Skill("React", null, false, "technology"))
  AddSkill(skills, new Skill("C#", null, false, "language"))
  AddSkill(skills, new Skill("Unity3D", null, false, "technology"))
  AddSkill(skills, new Skill("Javascript", null, false, "language"))
  AddSkill(skills, new Skill("Ionic", null, false, "technology"))
  AddSkill(skills, new Skill("React Native", null, false, "technology"))
  AddSkill(skills, new Skill("Xamarin", null, false, "technology"))
  AddSkill(skills, new Skill("Swift", null, false, "language"))
  AddSkill(skills, new Skill("Objective C", null, false, "language"))
  AddSkill(skills, new Skill("Sql", null, false, "technology"))
  AddSkill(skills, new Skill("Windows", null, false, "technology"))
  AddSkill(skills, new Skill("Linux", null, false, "technology"))
  AddSkill(skills, new Skill("svn", null, false, "technology"))
  AddSkill(skills, new Skill("Oracle", null, false, "technology"))
  AddSkill(skills, new Skill("Sql Server", null, false, "technology"))
  AddSkill(skills, new Skill("Mobile", null, false, "technology"))
  AddSkill(skills, new Skill("Android", null, false, "technology"))
  AddSkill(skills, new Skill("iOS", null, false, "technology"))
  AddSkill(skills, new Skill("Visual Basic 6", null, true, "language"))
  AddSkill(skills, new Skill("git", null, false, "technology"))
  AddSkill(skills, new Skill("Typescript", null, false, "language"))
  AddSkill(skills, new Skill("Xamarin Forms", null, false, "technology"))
  AddSkill(skills, new Skill("WebGL", null, false, "technology"))
  AddSkill(skills, new Skill("OpenCv", null, true, "technology"))
  AddSkill(skills, new Skill("MFC", null, true, "technology"))
  AddSkill(skills, new Skill("AR", null, true, "technology"))
  AddSkill(skills, new Skill("Network", null, true, "technology"))
...
export const FillJobPositionWithProjectInfo = (profile : Profile) => {
  profile.projectHistory.forEach ( project => {
    if (project.jobPositionId) {
      const position = profile.workHistory.find( el => el.id === project.jobPositionId)
      if (position) {
        position.projectList.push(new ProjectPreview(project.id, project.name))
      }
    }
  })
}